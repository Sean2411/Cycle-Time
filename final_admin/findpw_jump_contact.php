...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" style="font-size: large;">
	     The secret questions have not been set up yet! <br>
	     Please contact JVA company!<br>
	     This page will automatically jump to CONTACT INFO in 
         <span id="endtime" style="color:blue">5</span>
         seconds!
         <br/>
         <a href = "findpw_contact_info.php">
...
var id = 	setInterval(function(){
	if(navigator.userAgent.indexOf("MSIE")>0) {
      var obj = document.getElementById('endtime');
        ...
        if(num<=0){
     		 window.location.href= basePath + "findpw_contact_info.php";
     	}
			    obj.innerHTML = num-1;
