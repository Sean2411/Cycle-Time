...
if(isset($_SESSION["products"]))
{
  ...
  echo '<span class="empty-cart"><a href="process_create.php?emptycart=1&return_url='.$current_url.'">Empty Cart</a></span>';
}
if(!isset($_SESSION["products"])){
...
?>
     ...
     <?php include('set_create.php');
// echo $_POST['set_name'];
 ?>
  <h3>Wanna start a Process. Go to <a href="processanalysis.php">Process-Analysis</a> Page</a></h3>  
